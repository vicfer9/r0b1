...
<body>
  ...
  <div id="nouvellePubli">
    <span id="nvPb"> Nouvelle publication...</span>
    <img src="Ressources/camera.png" id="camera" border="0" style="width: 53px;">
    <img src="Ressources/appareilPhoto.png" id="appareilPhoto" border="0" style="width: 60px;">
  </div>
  ...
  <div class="publication">
    ...
    <div class="partieTexte">
      ...
      <div class="description">
        <br />
          Dans le souci d’assurer un contact étroit et constructif entre ses étudiants et le monde professionnel, la Faculté des Sciences Appliquées de 
        <br />
      </div>
      <div class="lieuDate">
        <span class="lieu"> <img src="Ressources/lieu.png" class="lieu" border="0" style="width: 20px;"> Eiffel 1 - EM 09</span>
